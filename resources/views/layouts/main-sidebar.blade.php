    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <li class="side-item side-item-category">Todos</li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">Todos</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">



                            <li><a class="slide-item" href="{{ url('/' . ($page = 'todos')) }}">Todo-list</a></li>
                    </ul>
                </li>
